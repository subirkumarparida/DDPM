...
class UNet(nn.Module):
    def __init__(self, c_in=3, c_out=3, time_dim=256, device="cuda"):
        ...
        self.sa1 = SelfAttention(channels=128, height=128)
        self.down2 = Down(in_channels=128, out_channels=256)
        self.sa2 = SelfAttention(channels=256, height=64)
        self.down3 = Down(in_channels=256, out_channels=256)
        self.sa3 = SelfAttention(channels=256, height=32)
        self.down4 = Down(in_channels=256, out_channels=256)
        self.sa4 = SelfAttention(channels=256, height=16)
        self.down5 = Down(in_channels=256, out_channels=256)
        self.sa5 = SelfAttention(channels=256, height=8)
        ...
        self.sa6 = SelfAttention(channels=256, height=16)
        self.up2 = Up(in_channels=512, out_channels=256)
        self.sa7 = SelfAttention(channels=256, height=32)
        self.up3 = Up(in_channels=512, out_channels=128)
        self.sa8 = SelfAttention(channels=128, height=64)
        self.up4 = Up(in_channels=256, out_channels=64)
        self.sa9 = SelfAttention(channels=64, height=128)
        self.up5 = Up(in_channels=128, out_channels=64)
        #self.sa10 = SelfAttention(channels=64, height=256)
...
def launch():
    ...
    args.run_name = "DDPM_Unconditional_Face_256"
    args.epochs = 500
    args.batch_size = 1
    args.image_size = 256
    args.dataset_path = r"/home/barc/Desktop/subir/Projects/denoising-diffusion-gan-main/data/celebahq1024_imgs/train" #r"/home/barc/Desktop/subir/datasets/MS1MV2-10K"
    args.device = "cuda"
    args.lr = 3e-4
    train(args)
