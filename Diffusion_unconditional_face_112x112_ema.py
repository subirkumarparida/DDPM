...
class Diffusion:
    ...
    def __init__(self, noise_steps=1000, beta_start=1e-4, beta_end=0.02, img_size=112, device="cuda"):
...
class UNet(nn.Module):
    def __init__(self, c_in=3, c_out=3, time_dim=256, device="cuda"):
        ...
        self.sa1 = SelfAttention(channels=128, height=56)
        self.down2 = Down(in_channels=128, out_channels=256)
        self.sa2 = SelfAttention(channels=256, height=28)
        self.down3 = Down(in_channels=256, out_channels=256)
        self.sa3 = SelfAttention(channels=256, height=14)
        ...
        self.sa4 = SelfAttention(channels=128, height=28)
        self.up2 = Up(in_channels=256, out_channels=64)
        self.sa5 = SelfAttention(channels=64, height=56)
        self.up3 = Up(in_channels=128, out_channels=64)
        self.sa6 = SelfAttention(channels=64, height=112)
...
def launch():
    ...
    args.run_name = "DDPM_Unconditional_Face"
    args.epochs = 500
    args.batch_size = 1
    args.image_size = 112
